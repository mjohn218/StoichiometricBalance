...
#For MAC users, specify directories for quadmath, stdc++, libm, and gfortran
GCCLIB = /usr/local/gfortran/lib/gcc/x86_64-apple-darwin14/4.9.2
GFLIB = /usr/local/gfortran/lib

#For LINUX users, specify directories for blas (or g2c), stdc++, libm, and gfortran 
...
FLIBSMAC    =  -L$(GCCLIB) -L$(GFLIB) -lgfortran -lquadmath -lm -lstdc++ -framework accelerate
