  ...
  */
  ...
  for(int nc=0;nc<nruns+1;nc++){
	...
	*/
    ...
    qp_solve(Npro, Nif, Ncomplex, wholep, indivconc, complexconc, A, plist, Nconstrain, constrain, rval, Q, c, xlow, xupp, ixlow, ixupp, irowQ, jcolQ, dQ, clow, cupp, iclow, icupp, irowC, jcolC, dC, H, ZA, Q2, ascale,p_home);      
